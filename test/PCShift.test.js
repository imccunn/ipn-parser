...
describe('PCShift specifications - ', () => {
  it('should return a PC set whose first element is the given pitch class C', () => {
    let expectedResult = ['C','C#/Db','D','D#/Eb','E','F','F#/Gb','G','G#/Ab','A','A#/Bb','B'];
    expect(PCShift('C')).to.eql(expectedResult);
  });

  it('should return a PC set whose first element is the given enharmonic pitch class Gb/F#', () => {
  ...
  it('should return a PC set whose first element is the given enharmonic pitch class A#/Bb', () => {
  ...
  it('should return a PC set whose first element is the given enharmonic pitch class D#/Eb', () => {
